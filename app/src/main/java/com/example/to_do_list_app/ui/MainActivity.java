...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onResume() {
        super.onResume();
        inputUsernameOrEmail.setText(null);
    ...
    private static final String LOGIN_URL = "https://testproject0602.000webhostapp.com/login.php";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    if (response.getInt(KEY_STATUS) ==  0){
                        ...
                        Toast.makeText(MainActivity.this, response.getString(KEY_MESSAGE), Toast.LENGTH_LONG).show();
